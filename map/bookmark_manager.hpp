...
public:
  ...
  bool HasRecentlyDeletedBookmark() const { return m_recentlyDeletedBookmark != nullptr; };
  void SetRecentlyDeletedBookmark(std::unique_ptr<Bookmark> && bookmark);
  void RemoveRecentlyDeletedBookmark();
...
private:
  ...
  std::unique_ptr<Bookmark> m_recentlyDeletedBookmark = nullptr;
